...
#define CLR_MASK (~PTE_NR & ~PTE_NX) & (PTE_W)
...
static int modify_region(uintptr_t vstart, uintptr_t vend, uintptr_t setmask)
{
  ...
  l1vaddr = loongarch_pgvaddr(READ_CSR64(LOONGARCH_CSR_PGDH));
