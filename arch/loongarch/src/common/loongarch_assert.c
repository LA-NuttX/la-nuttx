/****************************************************************************
 * arch/loongarch/src/common/loongarch_assert.c
 *
...
static inline void loongarch_registerdump(volatile uintptr_t *regs)
{
  ...
  _alert("T0: %" PRIxREG " T1: %" PRIxREG " T2: %" PRIxREG
         " T3: %" PRIxREG "T4: %" PRIxREG "\n",
         regs[REG_T0], regs[REG_T1], regs[REG_T2], regs[REG_T3], regs[REG_T4]);
  _alert(" T5: %" PRIxREG " T6: %" PRIxREG " T7: %" PRIxREG " T8: %" PRIxREG "\n",
         regs[REG_T5], regs[REG_T6], regs[REG_T7], regs[REG_T8]);
  ...
  _alert("S8: %" PRIxREG " S9: %" PRIxREG "\n",
         regs[REG_S8], regs[REG_S9]);
...
/****************************************************************************
 * Name: loongarch_dumpstate
 ****************************************************************************/

static void loongarch_dumpstate(void)
{
  ...
  loongarch_registerdump(rtcb->xcp.regs);
