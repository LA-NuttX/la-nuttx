/****************************************************************************
 * arch/loongarch/src/common/pgalloc.h
 *
...
#ifndef __ARCH_LOONGARCH_SRC_COMMON_PGALLOC_H
#define __ARCH_LOONGARCH_SRC_COMMON_PGALLOC_H
...
#  error "LOONGARCH needs CONFIG_ARCH_PGPOOL_MAPPING"
#endif
...
static inline uintptr_t loongarch_pgvaddr(uintptr_t paddr)
{
...
static inline void loongarch_pgwipe(uintptr_t paddr)
{
  uintptr_t vaddr = loongarch_pgvaddr(paddr);
  memset((void *)vaddr, 0, MM_PGSIZE);
}

#endif /* CONFIG_MM_PGALLOC */
#endif /* __ARCH_LOONGARCH_SRC_COMMON_PGALLOC_H */
